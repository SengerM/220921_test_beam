...
def measure_iv_curves_on_multiple_slots(bureaucrat:RunBureaucrat, voltages:dict, current_compliances:dict, n_measurements_per_voltage:int, name_to_access_to_the_setup:str, silent:bool=False):
